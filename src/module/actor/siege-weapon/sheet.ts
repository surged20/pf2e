...
import { SiegeWeaponPF2e } from "@actor/siege-weapon";
...
export class SiegeWeaponSheetPF2e extends ActorSheetPF2e<SiegeWeaponPF2e> {
    ...
    override get template(): string {
        return "systems/pf2e/templates/actors/siege-weapon/siege-weapon-sheet.html";
    }
    ...
    override async prepareItems(sheetData: ActorSheetDataPF2e<SiegeWeaponPF2e>): Promise<void> {
